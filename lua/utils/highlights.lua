...
-- Winbar diff.
vim.cmd([[hi DiffAdded guifg=#a1cd5e guibg=NONE]])
vim.cmd([[hi DiffChanged guifg=#e3d18a guibg=NONE]])
vim.cmd([[hi DiffRemoved guifg=#fc514e guibg=NONE]])
...
vim.cmd([[hi TabLineFill guifg=white guibg=none]])
